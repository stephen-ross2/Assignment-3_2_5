namespace Assignment_3_2_5
{
    internal class Program
    {
...

        {
            ...
            string[] inputStringArray = userInputElements.Split(" ");
            int[] userIntArray = Array.ConvertAll(inputStringArray, int.Parse);

            Console.WriteLine("\nWhat element do you want to index?");
            int numberToIndex = int.Parse(Console.ReadLine());

            int index = FindIndex(userIntArray, numberToIndex); //Declare "index" as a variable and use the FindIndex method to 
